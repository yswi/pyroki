...
project = "pyroki"  # Change project name
...
html_theme_options = {
    ...
    "footer_icons": [
        {
            "name": "GitHub",
            "url": "https://github.com/chungmin99/pyroki-dev",
            "html": """
...
#
html_theme = "furo"
html_title = "pyroki"  # Update title
...
htmlhelp_basename = "pyroki_doc"  # Update basename
...
man_pages = [
    (master_doc, "pyroki", "pyroki documentation", [author], 1)
...
texinfo_documents = [
    (
        master_doc,
        "pyroki",  # Update target name
        "pyroki",  # Update title
        author,
        "pyroki",  # Update dir menu entry
