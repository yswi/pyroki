...
+====+============+==============+===================+===============+==================+==================+===================+===============+======================+==================+
|  0 | franka.yml |            1 |           4.98486 |        100    |      0.000739527 |      2.54939e-06 |           3.35932 |           100 |          8.50313e-05 |      5.65459e-07 |
+----+------------+--------------+-------------------+---------------+------------------+------------------+-------------------+---------------+----------------------+------------------+
|  1 | franka.yml |           10 |           5.25212 |        100    |      0.00267408  |      5.58381e-06 |           3.56722 |           100 |          0.000164867 |      2.72384e-07 |
+----+------------+--------------+-------------------+---------------+------------------+------------------+-------------------+---------------+----------------------+------------------+
|  2 | franka.yml |          100 |           6.79851 |        100    |      0.00359474  |      7.05379e-06 |           4.86302 |           100 |          0.000299605 |      4.1879e-07  |
+----+------------+--------------+-------------------+---------------+------------------+------------------+-------------------+---------------+----------------------+------------------+
|  3 | franka.yml |         1000 |          26.4444  |        100    |      0.00470231  |      6.96488e-06 |          15.3825  |           100 |          0.000254631 |      3.888e-07   |
+----+------------+--------------+-------------------+---------------+------------------+------------------+-------------------+---------------+----------------------+------------------+
|  4 | franka.yml |         2000 |          50.4391  |         99.95 |      0.0043114   |      6.93035e-06 |          32.9647  |           100 |          0.000303925 |      4.71277e-07 |
+----+------------+--------------+-------------------+---------------+------------------+------------------+-------------------+---------------+----------------------+------------------+
...
class PyrokiIkBeamHelper:
    ...
    def solve_ik(self, target_wxyz: jax.Array, target_position: jax.Array) -> jax.Array:
        ...
        best_initial_sols = jnp.argsort(
            summary.cost_history[jnp.arange(num_seeds_init), summary.iterations]
        )[:num_seeds_final]

        # Optimize more for the best initial solutions.
        best_sols, summary = vmapped_solve(
            initial_sols[best_initial_sols],
            summary.lambda_history[jnp.arange(num_seeds_init), summary.iterations][
                best_initial_sols
            ],
